...
export class ProductService {
  ...
  listaProductos: VProduct[] = [
    ...
    { id: 99999, name: 'IPhone de Temu 😍😍', flavor: 'De Temu',price: 'Quina',url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5ImC-6Bvpq71CDqHn0VtMhYrCmpVVPu_gSzzwjdDOfezIjPVpBX5VCynWGDtBlz3H2L4&usqp=CAU' }
  ];
